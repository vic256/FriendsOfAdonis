...
router
  .get("/admin/custom-page", ({ inertia }: HttpContext) => {
...
```vue title="inertia/pages/custom-page.vue"
<temlate>
  <Layout
    :menu="menu"
    :resources="resources"
...
<Callout>
  Read more about the available methods, components and utils on the [Frontend
  reference page](../references/frontend.md).
</Callout>
...
<Callout>
  You can read more information about menu configuration on the [Menu
  documentation page](./menu.md)
</Callout>
